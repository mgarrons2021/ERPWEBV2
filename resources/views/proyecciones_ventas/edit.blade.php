...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Stock Nro: {{ $proyecciones_ventas->id }}</h3>
    </div>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered" >
                            ...
                            <tbody id="cuerpotabla">
                                ...
                                @foreach($proyecciones_ventas->detalles_proyecciones_ventas as $detalle )
                                <tr>
...
<script type="text/javascript" src="{{ URL::asset('assets/js/proyecciones_ventas/edit.js') }}"></script>
<script>

let ruta_actualizarPedido = "{{ route('proyecciones_ventas.actualizarStock') }}";
let ruta_asignar_stock_index = "{{ route('proyecciones_ventas.index') }}";
