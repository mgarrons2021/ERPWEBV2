...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Agreagar Venta Real</h3>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" style="width: 100%;" id="table">
                    <thead class="table-info">
                        ...
                        <th style="text-align: center;">Venta Real AM</th>
                        <th style="text-align: center;">Venta Real PM</th>
                    ...
                    <tbody id="tbody">
                        ...
                        <td style="text-align: center;">{{$detalle->venta_real_am}}</td>
                        <td style="text-align: center;">{{$detalle->venta_real_pm}}</td>
                        <td style="text-align: center;">{{$detalle->venta_real_subtotal}}</td>
                        </tr>
                        @endforeach
                        @endif
                    </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="modalFormData" action="{{ route('proyecciones_ventas.agregarNuevaVentaReal') }}  " method="POST" name="modalFormData" class="form-horizontal" novalidate="">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="inputLink" class="col-sm-2 control-label">Turno</label>
                        <div class="col-sm-10">
                            <select class="input-sm form-control" id="sucursal" name="turno" aria-label="Default select example">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="pm" name="venta" placeholder="0.0000" value="">
                        </div>
                    </div>
                    <div class="card-footer">
