    ...
    <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" style="width: 100%;" id="table">
                    <thead class="table-info">                       
                        ...
                        <th style="text-align: center;">Cantidad Solicitada AM</th>
                        <th style="text-align: center;">Cantidad Solicitada PM</th>
        ...
        <div class="card-footer">
            ...
            <div class=" text-center">
                ...
                <a type="button" class="btn btn-outline-info" id="nuevos" href="{{route('proyecciones_ventas.create')}}">Agregar Nuevos Productos </a>
            </div>
        </div>
    </div>
</section>
...
<script>
    ...
    let ruta_agregar_insumo = "{{ route('proyecciones_ventas.agregarInsumo') }}";
    let ruta_obtener_precios = "{{route('proyecciones_ventas.obtenerPrecios')}}"
    let ruta_eliminar_insumo = "{{ route('proyecciones_ventas.eliminarInsumo') }}";
    let ruta_guardar_pedido = "{{ route('proyecciones_ventas.pedido_especial_store') }}";
    let ruta_pedidos = "{{ route('proyecciones_ventas.index') }}";
    let ruta_obtener_plato = "{{route('proyecciones_ventas.obtenerPlato')}}";
