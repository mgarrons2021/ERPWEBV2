...
<script type="text/javascript" src="{{ URL::asset('assets/js/proyecciones_ventas/create.js') }}"> </script>
<script>
    let ruta_guardardetalle = "{{ route('proyecciones_ventas.guardarDetalle') }}";
    let ruta_eliminardetalle = "{{ route('proyecciones_ventas.eliminarDetalle') }}";
    let ruta_registrar_Stock = "{{ route('proyecciones_ventas.registrar_Stock') }}";
    let ruta_registrar_Stock_index = "{{ route('proyecciones_ventas.index') }}";
</script>
