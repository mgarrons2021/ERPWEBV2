...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Stock Ideal de la Sucursal: {{ $proyecciones_ventas->Sucursal->nombre }}</h3>
    </div>
                    ...
                    <table class="table table-bordered table-md">
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $proyecciones_ventas->fecha }}</td>
                            </tr>
                            <tr>
                                <th>Sucursal:</th>
                                <td>{{ $proyecciones_ventas->sucursal->nombre }}</td>
                            </tr>
