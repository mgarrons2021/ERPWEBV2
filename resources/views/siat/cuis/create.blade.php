...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Nuevo Cuis</h3>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card card-primary">
                            <br>
                            <form action="{{ route('cuis.store') }}" method="POST" class="form-horizontal">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a class="btn btn-danger" href="{{route('cuis.index')}}">Volver</a>
                                </div>
                                <br>
                            </form>
