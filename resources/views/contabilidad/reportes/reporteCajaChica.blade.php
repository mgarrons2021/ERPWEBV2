...
<section class="section">
    <div class="section-header">
        ...
        @endphp
        <h3 class="page__heading">Reporte Caja Chica </h3>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive" style="overflow-x: hidden">
                            <form action="{{route('contabilidad.filtrarCajaChica')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-8">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered " id="table">
                            <thead style="background-color: #6777ef;">
                                ...
                                <th style="color: #fff;;text-align:center">Nro de Factura</th>
                                <th style="color: #fff;;text-align:center">Tipo de Egreso</th>
                                <th style="color: #fff;;text-align:center">Glosa</th>
                            ...
                            <tbody>
                                ...
                                @foreach($item->detalles_caja_chica as $detalle)
                                @if($detalle->tipo_comprobante=="F")
                                @php
                                $total_egreso+=$detalle->egreso;
                                @endphp
                                <tr>
                                    ...
                                    <td style="text-align:center" class="table-primary">Bs{{ number_format($detalle->egreso,2,',','.') }}</td>
                                </tr>
                                @endif
                                @endforeach
                                @endforeach
                            ...
                            <tfoot>
                                <td style="text-align:center" colspan="5" class="table-warning">TOTAL EGRESO </td>
                                <td style="text-align:center" class="table-primary">Bs{{ number_format($total_egreso,2,',','.') }}</td>
                            </tfoot>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered " id="table2">
                            <thead style="background-color: #6777ef;">
                                <th style="color: #fff;text-align:center">Fecha</th>
                                <th style="color: #fff;text-align:center">Sucursal</th>
                                <th style="color: #fff;;text-align:center">Nro de Recibo</th>
                                <th style="color: #fff;;text-align:center">Tipo de Egreso</th>
                                <th style="color: #fff;;text-align:center">Glosa</th>
                                <th style="color: #fff;;text-align:center">Egreso</th>
                            </thead>
