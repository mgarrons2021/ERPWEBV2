...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Actividades del Personal</h3>
    </div>
    <div class="section-body">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-warning" href="{{route('tareas.index')}}"><i class="fa fa-arrow-left"> Volver </i></a><br><br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <a href="{{ route('personales.actividadesUsuario', $usuario->id) }}" value="{{ $usuario->ci }}">{{ $usuario->ci }} </a>
                                        </td>
