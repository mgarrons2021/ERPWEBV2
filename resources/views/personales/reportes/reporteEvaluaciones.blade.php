@extends('layouts.app', ['activePage' => 'evaluaciones', 'titlePage' => 'Evaluaciones'])
...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Reporte Criterio de Evaluaciones</h3>
    </div>
                            ...
                            <table class="table table-striped mt-15" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        {{$horario->horas_trabajadas}}Hrs</td>
                                        <td>{{$horario->total_pagar}} Bs</td>
