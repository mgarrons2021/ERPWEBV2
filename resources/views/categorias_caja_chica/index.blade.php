...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Categorias de Caja Chica</h3>
        ...
        <div class="row">         
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a class="btn btn-outline-info" href="{{route('categorias_caja_chica.create')}}">Nueva categoria</a><br><br>
                                        ...
                                        <td>
                                            <div class="dropdown" style="position: absolute;">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item " href="{{ route('categorias_caja_chica.edit', $categoria->id) }}">Editar</a></li>
...
<script>
    let ruta_eliminarCategoria = "{{route('categorias_caja_chica.destroy','')}}"
    let ruta_indexCategoria = "{{route('categorias_caja_chica.index')}}"
