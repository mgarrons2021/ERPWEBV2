...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Nueva Categoria de Gastos</h3>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card card-primary">
                            <br>
                            <form action="{{ route('categorias_gastos_administrativos.store') }}" method="POST" class="form-horizontal">
                                @csrf
                                <div class="row ">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nombre">Codigo <span class="required">*</span></label>
                                            <input type="text" class="form-control  @error('nombre') is-invalid @enderror" name="codigo" placeholder="Nombre de la Categoria...">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a class="btn btn-danger" href="{{route('categorias_gastos_administrativos.index')}}">Volver</a>
                                </div>
                                <br>
                            </form>
