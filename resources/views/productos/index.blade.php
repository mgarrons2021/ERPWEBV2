...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Productos Registrados</h3>
    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped mt-15 " id="table">
                                <thead style="background-color: #6777ef;">
                                    ...
                                    <th class="text-center" style="color: #fff;">U.M. Compra</th>
                                    <th class="text-center" style="color: #fff;">U.M. Venta</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if (isset($producto->unidad_medida_compra))
                                        <td  class="text-center">{{$producto->unidad_medida_compra->nombre}} </td>
                                        @else
                                        <td  class="text-center"> No definido </td>
                                        @endif

                                        @if (isset($producto->unidad_medida_venta))
                                        <td  class="text-center">{{$producto->unidad_medida_venta->nombre}} </td>
                                        @else
                                        <td  class="text-center"> No definido </td>
                                        @endif
                                        ...
                                        <td  class="text-center">
                                            <div class="dropdown" style="position: absolute;">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    ...
                                                    <li><a href="#" class="dropdown-item" data-id="{{ $producto->id }}" onclick="deleteItem(this)">Eliminar</a></li>
                                                </ul>
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.value) {
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route('productos.destroy', '') }}/' + id,
                        headers: {
