...
Route::group(['middleware' => ['auth', 'role:Super Admin|RRHH|Chef Corporativo']], function () {
    ...
    Route::put('/platos/{id}', [App\Http\Controllers\PlatoController::class, 'update'])->name('platos.update');
    ...
    Route::post('/platos/filtrarPlatos', [App\Http\Controllers\PlatoController::class, 'filtrarPlatos'])->name('platos.filtrarPlatos');
});
